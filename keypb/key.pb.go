...
type Keyfile struct {
	...
	Key *Keyfile_Key `protobuf:"bytes,1,opt,name=key,proto3" json:"key,omitempty"`
}
...
func (x *Keyfile) GetKey() *Keyfile_Key {
	if x != nil {
		return x.Key
	}
	return nil
...
type Keyfile_Key struct {
	...
	Data []byte `protobuf:"bytes,1,opt,name=data,proto3" json:"data,omitempty"` // encrypted secret (see below)
	Init []byte `protobuf:"bytes,2,opt,name=init,proto3" json:"init,omitempty"` // initialization vector
	Salt []byte `protobuf:"bytes,3,opt,name=salt,proto3" json:"salt,omitempty"` // key generation salt
}
...
var file_key_proto_rawDesc = []byte{
	...
	0x70, 0x62, 0x22, 0x72, 0x0a, 0x07, 0x4b, 0x65, 0x79, 0x66, 0x69, 0x6c, 0x65, 0x12, 0x24, 0x0a,
	0x03, 0x6b, 0x65, 0x79, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x12, 0x2e, 0x6b, 0x65, 0x79,
	0x70, 0x62, 0x2e, 0x4b, 0x65, 0x79, 0x66, 0x69, 0x6c, 0x65, 0x2e, 0x4b, 0x65, 0x79, 0x52, 0x03,
	0x6b, 0x65, 0x79, 0x1a, 0x41, 0x0a, 0x03, 0x4b, 0x65, 0x79, 0x12, 0x12, 0x0a, 0x04, 0x64, 0x61,
	0x74, 0x61, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x12, 0x12,
	0x0a, 0x04, 0x69, 0x6e, 0x69, 0x74, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x04, 0x69, 0x6e,
	0x69, 0x74, 0x12, 0x12, 0x0a, 0x04, 0x73, 0x61, 0x6c, 0x74, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0c,
	0x52, 0x04, 0x73, 0x61, 0x6c, 0x74, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
var file_key_proto_depIdxs = []int32{
	1, // 0: keypb.Keyfile.key:type_name -> keypb.Keyfile.Key
